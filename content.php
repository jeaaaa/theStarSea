    ...
    <article class="p_a<?php if ( !has_post_thumbnail() ) { echo ' p_lt'; };?>">
        ...
        <div class="art_con">
            ...
            <div class="img_div">
                ...
                <?php } else{ ?>
                    <img src="<?php bloginfo('template_url');?>/images/upload/bg-one.png">
                <?php } ?>
                <span class="title_bg"></span>  
                <h1 class="art_title"><?php the_title(); ?></h1>
                <h2 class="art_author"><?php the_date(); ?></h2>
            </div>
            </a>
            ...
            <div class="art_info">
                ...
                <div class="author_div">
                    ...
                    <span class="p_i_r"><a href="<?php comments_link(); ?>" ><?php comments_number( __('还没吐槽','dpt') , __('一楼是基佬','dpt') , __('% 回复','dpt') ); ?></a></span>
